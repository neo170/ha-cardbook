  ...
  _styles() {
    return `
      *, *::before, *::after { box-sizing: border-box; }
      ...
      .btn-primary ha-icon, .btn-secondary ha-icon, .btn-danger ha-icon { --mdi-icon-size: 14px; flex-shrink: 0; }
      .btn-copy-inline ha-icon { --mdi-icon-size: 14px; flex-shrink: 0; }
      .photo-btn ha-icon { --mdi-icon-size: 14px; flex-shrink: 0; }
